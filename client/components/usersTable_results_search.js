...
const UsersTableResultsSearch = ({ setFilter, setResults }) => {
  return (
    <div className="py-2 justify-center flex w-screen sm:flex-row flex-col">
      ...
      <div className="flex  w-64 block relative">
